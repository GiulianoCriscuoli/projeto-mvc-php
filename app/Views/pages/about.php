<div class="container p-4">
    <div class="row vh-100">
        ...
        <h1 class="text-center"><?php echo $datas['pageTitle']; ?></h1>
            ...
            <p>A estrutura das pastas organizadas e com seus respectivos arquivos, de acordo com as funcionalidades corretas de cada código. A estrutura MVC é importante não apenas para organização, mas para facilitar a manutenção caso algum arquivo venha a ter algum bug ou necessite ser refatorado.</p>
        </div>
    </div> 
</div>